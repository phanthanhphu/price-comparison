...
public class ComparisonRequisitionResponseDTO {
    ...
    @Schema(description = "Total amount across all requisitions", example = "1000.0")
    ...
    public ComparisonRequisitionResponseDTO() {}

    public Page<ComparisonRequisitionDTO> getPage() { return page; }
    public void setPage(Page<ComparisonRequisitionDTO> page) { this.page = page; }

    public BigDecimal getTotalAmt() { return totalAmt; }
    public void setTotalAmt(BigDecimal totalAmt) { this.totalAmt = totalAmt; }

    public BigDecimal getTotalAmtDifference() { return totalAmtDifference; }
    public void setTotalAmtDifference(BigDecimal totalAmtDifference) { this.totalAmtDifference = totalAmtDifference; }

    public BigDecimal getTotalDifferencePercentage() { return totalDifferencePercentage; }
    public void setTotalDifferencePercentage(BigDecimal totalDifferencePercentage) { this.totalDifferencePercentage = totalDifferencePercentage; }
}
