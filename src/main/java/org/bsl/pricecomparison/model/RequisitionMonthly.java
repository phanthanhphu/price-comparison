...
import org.bsl.pricecomparison.dto.CompletedSupplierDTO; // THÊM IMPORT
...
public class RequisitionMonthly {
    ...
    @Schema(
            description = "List of matching suppliers found for price comparison. " +
                    "Already sorted by price in ascending order (lowest price first). " +
                    "The first element is the cheapest supplier."
    )
    ...
    public RequisitionMonthly(String id, String groupId, String itemDescriptionEN, String itemDescriptionVN, String oldSAPCode, String hanaSAPCode, String unit, List<DepartmentRequisitionMonthly> departmentRequisitions, BigDecimal dailyMedInventory, BigDecimal stock, BigDecimal totalRequestQty, BigDecimal safeStock, BigDecimal useStockQty, BigDecimal orderQty, BigDecimal amount, BigDecimal price, String currency, String goodType, String supplierId, String supplierName, String productType1Id, String productType2Id, String productType1Name, String productType2Name, LocalDateTime createdDate, LocalDateTime updatedDate, List<String> imageUrls, String fullDescription, String reason, String remark, String remarkComparison, RequisitionType type, List<CompletedSupplierDTO> supplierComparisonList, String statusBestPrice) {
        this.id = id;
